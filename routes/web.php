...
Route::get('/test-banner-create', function () {
    try {
...
// Test invoice view directly
Route::get('/test-invoice-view/{bookingId}', function ($bookingId) {
    try {
        ...
        if (!$booking->invoice) {
            ...
            $invoiceNumber = $tempInvoice->generateInvoiceNumber();
...
Route::get('/test-create-invoice/{bookingId}', function ($bookingId) {
    try {
        $booking = \App\Models\Booking::with(['user', 'tour'])->find($bookingId);
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/invoices/{invoice}/save-pdf', [InvoiceController::class, 'savePdf'])->name('invoices.save-pdf');
